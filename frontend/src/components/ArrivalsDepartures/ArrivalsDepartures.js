...
const Arrivals = props => {
    ...
    return (
        <div className={styles["arrivals-departures-wrapper"]}>
            <UserNavBar />
            
            <h1 style={{color: "#ffffff", textAlign: "center", backgroundColor: "rgba(0, 0, 0, 0.8)", padding: "15px"}}> 
                {props.heading} 
            </h1>
            ...
            <div className={styles["arrivals-departures"]}>
                ...
                {/* <ArrivalsDeparturesFlights 
                    ...
                    flights={flights} 
                    heading="Arrivals" 
                    loader={flights.length > 0 ? props.loader : "No arrivals"}
                /> */}
            </div>
        </div>
    );
