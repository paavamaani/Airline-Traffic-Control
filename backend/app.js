...
mongoose.connect(`mongodb+srv://admin:${process.env.MONGO_DB_PASSWORD}@airportmanagementsystem.43jdopo.mongodb.net/AirportManagementSystem?retryWrites=true&w=majority`);
